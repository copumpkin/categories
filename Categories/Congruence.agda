...
record Congruence {o a} (C : Category o a) q : Set (o ⊔ a ⊔ suc q) where
  open Category C
  field
    _≡₀_ : Rel Obj q
...
module Heterogeneous {o a} {C : Category o a} {q} (Q : Congruence C q) where
  open Category C
  open Congruence Q
...
TrivialCongruence : ∀ {o a} (C : Category o a) → Congruence C _
