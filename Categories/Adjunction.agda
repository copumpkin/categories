...
infix  4 _≡_
_≡_ : ∀ {o a} {o₁ a₁} {C : Category o a} {D : Category o₁ a₁} {F : Functor D C} {G : Functor C D} →  Rel (F ⊣ G) (o ⊔ a ⊔ o₁ ⊔ a₁)
_≡_ {C = C} {D} {F} {G} X Y = Adjunction.unit X ≡T Adjunction.unit Y ×
                                Adjunction.counit X ≡T Adjunction.counit Y

.equiv : ∀ {o a} {o₁ a₁} {C : Category o a} {D : Category o₁ a₁} {F : Functor D C} {G : Functor C D} → IsEquivalence (_≡_ {F = F} {G})
...
setoid : ∀ {o a} {o₁ a₁} {C : Category o a} {D : Category o₁ a₁} {F : Functor D C} {G : Functor C D}
         → Setoid (o ⊔ a ⊔ o₁ ⊔ a₁) (o ⊔ a ⊔ o₁ ⊔ a₁)
